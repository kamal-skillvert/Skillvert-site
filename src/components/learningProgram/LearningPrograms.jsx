...
const LearningPrograms = () => {
    return (
        <div className="learning-program-block">
            <div className="learning-program-inner-block">
                    ...
                    <div className="col-lg-4">
                        <div className="pricing-item">
                            ...
                            <h4>
                                ...
                                <sup className="price">699/-</sup>
                                <sup className="price-duration">month</sup>
                            </h4>
                            <ul>
                                <li>
                                ...
                                <li>
                                    ...
                                    <span><del>Recorded Session</del></span>
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x" viewBox="0 0 16 16">
                                        <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                                    </svg>
                                    <span><del>Doubt Clearing Session</del></span>
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x" viewBox="0 0 16 16">
                                        <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                                    </svg>
                                    <span><del>Placement Assistance</del></span>
                                </li>
                                <li>
                                    ...
                                    <span><del>Interview Preparation Kit</del></span>
                                </li>
                            </ul>
                            <button className="btn btn-primary" id="overridden-btn">Buy Now</button>
                        </div>
                    </div>

                    <div className="col-lg-4">
                        <div className="pricing-item">
                            <h3>Mentor Lead Program</h3>
                            <h4>
                                <sup>
